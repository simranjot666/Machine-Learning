...
big_del2(:,2:size(big_del2,2)) =big_del2(:,2:size(big_del2,2))   +  (lambda/m)*Theta1(:,2:size(Theta1,2));
big_del3=big_del3+del3(:,t)*newp0(t,:); 
big_del3(:,2:size(big_del3,2)) =big_del3(:,2:size(big_del3,2))   +  (lambda/m)*Theta2(:,2:size(Theta2,2));
